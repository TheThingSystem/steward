    ...
    var f = function(q) {
      ...
      return { climate_control : function(entry) { if (entry.phrases['report'].selected) 
             ...
             , climate_soil    : function(entry) { if (entry.phrases['report'].selected) 
                                                     report(entry.entry,  [ 'temperature', 'moisture', 'light'        ], entry.phrases['report'].text);              }
...
var voiceUtils = {
  categories : [ {name: 'motive', img: 'popovers/assets/actors/motive-vehicle.svg', active: false, top: 0, left: 0}
               , {name: 'climate', img: 'popovers/assets/actors/sensor-climate.svg', active: false, top: 0, left: 0}
               , {name: 'lighting', img: 'popovers/assets/actors/lighting-downlight.svg', active: false, top: 0, left: 0}
               , {name: 'motive-lock', img: 'popovers/assets/actors/motive-lock.svg', active: false, top: 0, left: 0}
