...
PROGMEM prog_char *json_on = "{\"path\":\"/api/v1/actor/perform/device/lighting\",\"requestID\":\"1\",\"perform\":\"on\",\"parameter\":\"{\\\"brightness\\\":100}\"}";
...
void loop() {
  ...
  if( steward && flag == 0 ) {
    ...
    if( client.connect((char *)ip_to_str(steward),8887) ) {
      ...
      webSocketClient.sendData((char*)pgm_read_word(&json_on));
      flag = 1;
